      ...
      <div className='navbar-top'>  
        ...
        <div className='nav-contact'>
          <div className='nav-contact__call'>
            <i class="nav-contact__call--icon uil uil-calling"></i>
          ...
          <div className='nav-contact__timing'>
            <i class="nav-contact__timing--icon uil uil-clock-nine"></i>
          ...
          <div className='nav-contact__location'>
            <i class="nav-contact__location--icon uil uil-map-pin"></i>
